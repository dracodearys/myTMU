//+FHDR------------------------------------------------------------
//------------------------------------------------------------
//  File Name: sqrt_i2_v1.sv
//  Creating Date: Mon 15 Jan 2024 10:19:23 AM CST
//  Creating Author: sunhzh
//  Description:
//  Last Commit: Mon 15 Jan 2024 03:01:19 PM CST
...
mul32_32_top_improve_sep3 MUL0_0(
                              .i_clk(i_clk),
                              .i_reset_n(i_reset_n),
...
mul32_32_top_improve_sep3 MUL0_1(
                              .i_clk(i_clk),
                              .i_reset_n(i_reset_n),
                              .i_bus_stall_en(i_bus_stall_en),
                              .i_x(i_y_cv),
...
logic[31:0] i_b_cv_ex1;
always@(posedge i_clk or negedge i_reset_n)begin
  if(!i_reset_n)
    i_b_cv_ex1 <= 32'h0000_0000;
